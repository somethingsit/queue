...
//        System.out.println(daysBetween2Dates(now2, now));
    ...
    public static Date getLastDayOfMonth(Date date) {
        ...
        return java.util.Date.from(today.withDayOfMonth(today.getMonth().length(today.isLeapYear())).atStartOfDay()
                .atZone(ZoneId.systemDefault())
                .toInstant());
    }
    ...
    public static Date getFirstDayOfMonth(Date date) {
        LocalDate today = date.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        return java.util.Date.from(today.withDayOfMonth(1).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant());
    }
